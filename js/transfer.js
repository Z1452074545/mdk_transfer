$(function() {
    ...
    <span>${query_init.mark}</span>`
        ...
        $('.mc_title_affirm').on('click', function() {
            ...
            var html = ''
            html = `<div> 账户姓名：<span>${query_cond.com_name}</span> 账户账号：
            <span>${query_cond.mer_name}</span> 余额：
        ...
        table.render({
            ...
            cols: [
                [
                    ...
                    { field: 'com_name', title: '商户' },
                    { field: 'account_channel', title: '银行' },
                    { field: 'account_name', title: '账户类型' },
                    { field: 'account', title: '账户姓名', width: 120, },
                    { field: 'account_state', title: '银行卡号', },
                    { field: 'warning', title: '转账金额', width: 120, },
                    { field: 'scope', title: '业务类型' },
